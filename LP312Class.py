class CliP312:
  ...
  def __init__(self, fd, cg, et, rt):
    ...
    self.rent = rt
    self.budget = 0
    self.percents = [0] * 4  # same as doing [0, 0, 0, 0]
...
def main():
  ...
  #   Make a new CliP312 object, pass in the numbers to the constructor
  budget = CliP312(food, clothing, entertainment, rent)
  budget.calculate()
  budget.display()
